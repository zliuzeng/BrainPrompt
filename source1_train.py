...
def make_model_baseline_model(temperature=8,N=1, d_model1=6670, d_model2=28, d_ff=128, h1=2, dropout=0.5, device=0):
    ...
    model = source_model1.EncoderDecoder(
    ...
    for train_index, test_index in kf.split(X):
        ...
        for epoch in range(0, args.epoch_cf + 1):
            ...
            for i in range(0, int(X_train.shape[0]) // int(args.batch_size)):
                ...
                outputs,loss_l1= model(train_data_batch, src_mask=X_mask_train_batch)
                outputs = outputs.cpu()
            ...
            if epoch % 5 == 0:
                ...
                for i in range(0, int(X_train.shape[0]) // int(args.batch_size)):
                    ...
                    outputs,_ = model(train_data_batch, src_mask=X_mask_train_batch)
            ...
            if epoch % 5 == 0:
                ...
                outputs,_ = model(test_data_batch_dev, src_mask=X_mask_test_batch_dev)
            ...
            if epoch == args.best_epoch and args.save_model == 1:
                if args.model == 'source_model1':
                    save_path = f'./source_model1/{args.site}/{args.site_source}/{kfold_index}.pt'
